(function(){
  ...
  var css = [
    ...
    '.ip-badge{display:inline-block;font-size:11px;font-weight:600;letter-spacing:.08em;text-transform:uppercase;color:#E85D04;margin-bottom:12px;}',
    ...
    '.ip-price sup{font-size:.4em;vertical-align:super;color:#E85D04;}',
    ...
    '.ip-includes li::before{content:"✓";color:#E85D04;font-weight:700;font-size:13px;flex-shrink:0;}',
    '.ip-cta{display:block;width:100%;text-align:center;background:#E85D04;color:#fff;font-size:16px;font-weight:600;padding:16px 20px;border-radius:8px;text-decoration:none;transition:background .15s;}',
  ...
  var html = [
    ...
    '<h2 class="ip-headline" id="ipTitle">Claim Your $89<br>First Visit Intro</h2>',
    ...
    '</ul>',
    '<a href="'+offerUrl+'" class="ip-cta" id="introPopupCTA">Claim the $89 Intro Offer →</a>',
